...
st.markdown(
    """
    ### 👨‍💻 Developed by Sahil Khaire

    📌 **Educational & Portfolio Project**

    This application demonstrates ETL, Data Cleaning, Feature Engineering,
    Recommendation Systems, Python, SQL, and Streamlit skills.
    
    **🔗 Portfolio:** https://sahilkhaireportfolio.lovable.app

    **💼 LinkedIn:** https://www.linkedin.com/in/sahil-khaire-840b74326/

    **💻 GitHub:** https://github.com/sahiltech247

    **⚠️ Disclaimer:** Recommendations generated by this application are based only on the available dataset and scoring logic. They are intended solely for educational purposes and skill demonstration and should not be considered professional buying advice.
    """
)
